    ...
    stage('Copy artifacts') {
      steps {
        ...
        when {
            ...
            steps {
                sh 'docker run -v $HOME/workspace/Deploy/environments/production:/etc/newman -t postman/newman run "https://www.getpostman.com/collections/434a10daa020cc392009" -e prodoction.postman_environment.json'
                }
        }
